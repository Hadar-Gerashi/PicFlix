...
def profile(user_id):
    ...
    logged_user = read_user_by_id(logged_user_id)
        ...
        if action == "update":
            ...
            if file and file.filename != '':
                ...
                try:
                    ...
                    relative_path = full_url.split('/image/upload/')[-1]

                    update_user_profile_image(user_id, relative_path)

                    print(f"✅ Profile image uploaded successfully: {full_url}")
    ...
    return render_template("profile.html", videos=videos, categories=categories,
                           ...
                           categories_user=categories_user, logged_user=logged_user)
